...
tf.flags.DEFINE_string("filter_sizes",'3,5,6', "Comma-separated filter sizes (default: '3,4,5')")
...
tf.flags.DEFINE_integer("num_epochs", 138, "Number of training epochs (default: 200)")
